...
<!--        Часть отвечающая за ознакомительный текст-->
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium"> Присоединяйтесь и начните работать с уверенностью!</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Наш сервис предлагает вам доступ к проверенным контрагентам, удобному интерфейсу и прозрачной системе рейтингов, что гарантирует безопасность сделок и повышает доверие среди партнеров.
                    </p>
                ...
                <div class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] dark:bg-[#1D0002] lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none">
                    <img src="/storage/logo.png" alt="Описание изображения" class="w-full h-auto object-cover opacity-60">
